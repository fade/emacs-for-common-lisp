...
** Ement
This really is the best available client for matrix, and it's increasingly obvious that the young'uns won't be brought to IRC.
#+begin_src emacs-lisp
  (use-package ement
    :straight t
    :custom
  ...
  (use-package sly
    ...
    (progn
      (setf sly-lisp-implementations
            '((sbcl ("sbcl" "--dynamic-space-size" "8GB" "--core" "/home/fade/sbcl.core"))
