...
#+BEGIN_SRC emacs-lisp
  (setq org-capture-templates
        `(("t" "Tasks / Projects")
          ...
          ("a" "Appointment" entry (file+headline "~/Dropbox/OrgFiles/Tasks.org" "Inbox")
...
#+BEGIN_SRC emacs-lisp
  (straight-use-package
   '(shell-maker :type git :host github :repo "fade/shell-maker"
                 :local-repo "~/SourceCode/lisp/emacs_stuff/shell-maker"))

  (use-package agent-shell
    :straight (agent-shell :type git :host github :repo "fade/agent-shell"
                           :local-repo "~/SourceCode/lisp/emacs_stuff/agent-shell")
    ...
    (with-eval-after-load 'shell-maker
      (defun shell-maker--curl-version-supported ()
        "Force success for curl version check."
        t))
    :config
