...
#+begin_src emacs-lisp
  ...
  (use-package chatgpt-arcana
    ...
    :init (setq chatgpt-arcana-api-key "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")
    :config 
...
#+BEGIN_SRC emacs-lisp :tangle no
  ...
  (defadvice hl-line-mode (after
    ...
    (set-face-background hl-line-face "#0f0f0f"))
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
  ...
  ;;         '((tiny
  ;;            :default-family "Iosevka Wide Fixed"
  ;;            :default-height 70)
  ;;           (small
