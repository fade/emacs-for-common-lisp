        ...
        (delq nil
              (mapcar (lambda (x) (and (file-exists-p x) x))
                      (list
                       ...
                       (expand-file-name "personal-agenda.org" site-org-files)
    ...
    (progn
      ...
      (if (eql system-type 'gnu/linux)
          (setf sly-lisp-implementations
                '(;; (sbcl ("sbcl" "--core" "/home/oreillyb/sbcl.core")) ;;"--dynamic-space-size" "8GB"
                ...
                common-lisp-hyperspec-root "file:///home/oreillyb/SourceCode/lisp/HyperSpec/")
      ...
      (add-to-list 'load-path "~/SourceCode/lisp/sly/contrib")
      (require 'sly-tramp)
      (add-to-list 'sly-filename-translations
                   (sly-create-filename-translator
                    :machine-instance "synthia-hn1"
                    :remote-host "synthia-hn1.res.nrc.gc.ca"
                    :username "oreillyb"))))
...
#+begin_src emacs-lisp
  ...
  ;; corfu popup frames have some issues on terminal sessions. this
  ;; still doesn't fix it (within screen), so if you want to use this
  ;; config on a terminal, you might want to revisit the choice of corfu
  ;; entirely.

  ;; (when (and (not (display-graphic-p))
  ;;            (not (version< emacs-version "31")))
