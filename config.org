...
#+BEGIN_SRC emacs-lisp
  (if window-system
      (progn
        ...
        (set-face-attribute 'default nil :font "EnvyCodeR Nerd Font" :height 100)
        (set-face-attribute 'fixed-pitch nil :font "EnvyCodeR Nerd Font-10")
        ...
        (use-package fontaine
          ...
          ;;; fontaine is implemented as a theme now, so we need to
          ;;; ensure it is applied when themes change.
          ;;; emacs-version >= 29
