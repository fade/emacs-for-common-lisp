...
I'm using ollama for local LLM stuff, so lets see how that looks in emacs..
...
Democratize can extract thousands of usage examples (aka "demos") from
some of your favorite Emacs Lisp libraries and, among other things,
insert them into Helpful (or regular "Help") buffers when you look up
a function
