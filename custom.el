...
(custom-set-variables
 ...
 '(custom-safe-themes
   '("14d62ab7d23ec130697c9050718e7e3a230a97f30f838a475c8f45e0a262d050"
     ...
     "3aed30c256f3506b39fdf4a7143168f9ca624947a7ea77c08cf7bd65c0dab9b7"
     "f9b8de70122e2370c69f59592cfc162f55ceded36cbbf7f8962f4985124e949f"
     "eb6815efcf4b3506804a1aca00b4100bdf7a76664c6396c77a760791fd1fa6cb"
     "0becd5fdab50c67580f8ab05c71d8c632a24e5ede5f657ebf71d5f9fca3b879c"
     "e6cace7f97c0c42dd9656a8db27c92f27b6be6b2be3a44ed9f304648cf13a153"
     "dd8f89c0930a74fec169fa779822376a826147db9ecf784a2a12a7ae4d0ba2b5"
     "f1db6b75f93a964718258bf1cb78993b6b654468b1ee1e26df74c44ba99e8c4e"
     "cc8f5f7bdd13efd250c01db39a5193c948fba7c02e5ddc478f60d08347fe5405"
 ...
 '(safe-local-variable-values
   '((lexical-bindings . t) (Package . UTILS) (Package . TREE)
     ...
     (Package . POSTMODERN) (Package . CIRCULAR-BUFFER)
     (encoding utf-8) (Package . S-SQL) (package . RFC2388)
     (Package . FLEXI-STREAMS) (Package . CHUNGA) (Package . CL-PPCRE)
     (Package . CL-POSTGRES-TRIVIAL-UTF-8) (Package . CL-POSTGRES)
     (Syntax . Ansi-Common-Lisp) (Package . CL-WHO) (Package . LALR)
     (readtable . runes) (Package . CXML) (Syntax . Common-Lisp)
     (package . rune-dom) (Package . DRAKMA) (Package . HUNCHENTOOT)
     (Package . FSet)
     (eval cl-flet
           ((enhance-imenu-lisp (&rest keywords)
                                (dolist (keyword keywords)
                                  (add-to-list
                                   ...
                                   (list
                                    ...
                                    2)))))
           (enhance-imenu-lisp "bookmarklet-command" "class" "command"
                               "function" "mode" "parenscript"
                               "user-class"))
     (Package . CL-UNICODE) (Package . containers)
     (eval put 'test-js-eval 'common-lisp-indent-function 1)
     (eval put 'test-ps-js 'common-lisp-indent-function 1)
     (indent-tabs) (Package . CL-FAD) (Syntax . COMMON-LISP)
     (Package . Lexical-Contexts) (Base . 10)
     (Syntax . ANSI-Common-Lisp) (eval sh-set-shell "zsh")))
 '(save-place-mode t)
...
(custom-set-faces
 ...
 ;; Your init file should contain only one such instance.
 ;; If there is more than one, they won't work right.
 '(magit-diff-added-highlight ((t (:extend t :background "DarkSlateBlue")))))
